...
public class BorderEffect implements BorderView.Effect {
    ...
    public FocusListener focusPlayListener = new FocusListener() {
        ...
        public void onFocusChanged(View oldFocus, View newFocus) {
            try {
                if (newFocus instanceof AbsListView) return;
    ...
    protected VisibleScope checkVisibleScope(View oldFocus, View newFocus) {
        ...
        try {
            ...
            if (oldFocus == null || attacheViews.indexOf(oldFocus.getParent()) < 0) {
                scope.oldFocus = null;
                if (newFocus == null || attacheViews.indexOf(newFocus.getParent()) < 0) {
                    scope.newFocus = null;
                    mTarget.setVisibility(View.INVISIBLE);
                    return scope;
                } else {
    ...
    public void onFocusChanged(View target, View oldFocus, View newFocus) {
        try {
            //Log.d(TAG, "onFocusChanged:" + oldFocus + "=" + newFocus);
            if (oldFocus == newFocus || newFocus == null) return;
...
//            Log.d(TAG, "onLayout");
    ...
    public void onAttach(View target, View attachView) {
        try {
            ...
            if (attachView instanceof RecyclerView) {
                ...
                View temp = null;
                if (absListView.getChildCount() > 0) temp = absListView.getChildAt(0);
    ...
    protected class MyOnItemSelectedListener implements AdapterView.OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            try {
                if (onItemSelectedListener != null && parent != null) onItemSelectedListener.onItemSelected(parent, view, position, id);
